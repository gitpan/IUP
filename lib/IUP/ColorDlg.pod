...
=item * L<0-basic/colordlg.pl|http://cpansearch.perl.org/src/KMX/IUP-0.001_12/examples/0-basic/colordlg.pl> - IUP::ColorDlg example (used for screenshot - IUP.pod)
